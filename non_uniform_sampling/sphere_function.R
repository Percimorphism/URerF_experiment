...
non_uniform_sampleing_upper_sphere<-function(r=3, N=200, plot=TRUE){
  ...
  u=(rnorm(N, mean = pi/6, sd = 0.3))
  v=(rnorm(N, mean = pi/7, sd = 0.3))
  u_v=t(rbind(u,v))
  parameters=rbind(parameters, u_v)
  u=(rnorm(N, mean = pi/3, sd = 0.3))
  v=(rnorm(N, mean = pi/4, sd = 0.3))
  u_v=t(rbind(u,v))
  parameters=rbind(parameters, u_v)
  u=(rnorm(N, mean = 2*pi, sd = 0.3))
  v=(rnorm(N, mean = 3*pi, sd = 0.3))
  u_v=t(rbind(u,v))
  parameters=rbind(parameters, u_v)
  u=(rnorm(N, mean = pi/77, sd = 0.3))
  v=(rnorm(N, mean = pi/4, sd = 0.3))
  u_v=t(rbind(u,v))
  parameters=rbind(parameters, u_v)
